"""
Django settings for alteza_proefopdracht project.
...
SECRET_KEY = "django-insecure-q+%=n2p9k_yxa-_+p&^(9n$x9cyz2id8kmw&5cvu1ajiza%0ac"
...
WSGI_APPLICATION = "alteza_proefopdracht.wsgi.application"
